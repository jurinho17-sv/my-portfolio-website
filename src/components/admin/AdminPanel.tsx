...
export default function AdminPanel({ posts, projects }: AdminPanelProps) {
              ...
              <div key={post.slug} className="border border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    <Button
                      href={`https://github.com/jurinho17-sv/my-portfolio-website/edit/main/content/blog/${post.slug}.md`}
                      target="_blank"
                      variant="outline"
                      size="sm"
                    >
            ...
            {projects.map(project => (
              <div key={project.slug} className="border border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    <Button
                      href={`https://github.com/jurinho17-sv/my-portfolio-website/edit/main/content/projects/${project.slug}.md`}
                      target="_blank"
                      variant="outline"
                      size="sm"
                    >
